	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'form',
	                { id: 'task-input', onSubmit: this.handleForm },
	                React.createElement('input', { className: 'text task', ref: 'new-task', placeholder: 'Add an item to the TODO list', autoFocus: 'true' }),
	                React.createElement(
	                    'button',
